package edu.usit.deepanker.constants;
 ...
 */
public class MutationRegexPattern {
    ...
    public static final Pattern THIS_KEYWORD_REPLACEMENT_PATTERN=Pattern.compile("this\\.");
}
